  ...
  return (
    <>
        ...
        <div className="">
          <div
            className={`transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${
                "bg-(--dark-1) shadow-[0_18px_60px_rgba(0,0,0,0.22)] backdrop-blur-2xl" 
            }`}
          >
            <nav className="flex items-center justify-between px-4 py-3 sm:px-5 lg:px-6 mx-auto max-w-7xl">
                ...
                {navItems.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span
                        className={`absolute bottom-[7px] left-1/2 h-[2px] -translate-x-1/2 rounded-full bg-[var(--orange-1)] transition-all duration-300 ${
              ...
              >
                ...
                <div className="relative h-4 w-5">
                  <span
                    className={`absolute left-0 top-0 h-[2px] w-5 origin-center rounded-full bg-current transition-all duration-300 ${
                  ...
                  />
                  <span
                    className={`absolute left-0 top-[14px] h-[2px] w-5 origin-center rounded-full bg-current transition-all duration-300 ${
                      isOpen ? "-translate-y-[7px] -rotate-45" : ""
                    }`}
                  />
                </div>
          ...
          {/* Mobile Menu */}
          <div
            className={`md:hidden transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${
              isOpen
          ...
          >
            <div
              className={`origin-top rounded-[1.75rem] border border-white/10 bg-[var(--dark-1)]/85 p-3 shadow-[0_24px_80px_rgba(0,0,0,0.3)] backdrop-blur-2xl transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${
                isOpen
            ...
            >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`mt-3 inline-flex w-full items-center justify-center rounded-full bg-[var(--orange-1)] px-5 py-3 text-sm font-semibold text-white shadow-[0_12px_30px_rgba(249,115,22,0.18)] transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] hover:shadow-[0_18px_40px_rgba(249,115,22,0.28)] ${
                  isOpen
                    ? "translate-y-0 opacity-100"
                    : "translate-y-2 opacity-0"
                }`}
      ...
      <button
        ...
        className={`fixed inset-0 z-40 bg-black/25 backdrop-blur-[2px] transition-all duration-500 md:hidden ${
          isOpen
